...
namespace Restaurants.Services.Controllers
{
    ...
    {
        //public RestaurantsController(IRestaurantsUnitOfWork data)
        //    : base(data)
        //{
        //}
        ...
        public IHttpActionResult GetRestaurants([FromUri] string townId = null)
        {
            ...
            var ratingStars = this.Data.Ratings.Select(r => r.Stars);

            var restaurants = this.Data.Restaurants
                .Where(r => r.TownId == id)
                .OrderByDescending(r => ratingStars.Average())
                .ThenBy(r => r.Name)
                .Select(r => new
                {
                    Id = r.Id,
        ...
        public IHttpActionResult PostRestaurant(RestaurantBindingModel model)
        {
            ...
            var townName = this.Data.Towns.FirstOrDefault(r => r.Id == restaurant.TownId);

            return CreatedAtRoute("DefaultApi", new { id = restaurant.Id },
                new
                {
                    Id = restaurant.Id,
                    Name = restaurant.Name,
                    Rating = stars,
                    Town = new { Id = restaurant.TownId, Town = townName.Name }
                });
        }
